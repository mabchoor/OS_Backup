...
# Check if source and backup folder paths are provided
if [ $# -ne 2 ]; then
...
# Combinate previously defined variables for use
...
rsyncExitCode=${?}
if [ ${rsyncExitCode} -eq 0 ] || [ ${rsyncExitCode} -eq 24 ]; then
